...
surface_pars = struct('alpha_const', 0.9, 'colormap', cm, 'colorlimits', colorlimits, ...
  'showdirections', 0, 'colorbars', 0, 'dipnames', [], 'mymarkersize', 12, 'directions', [0 0 1 1 1 1], ...
...
figure; showsurface3BS(vc, cortex.Faces_left, surface_pars, data, varargin1{:});
export_fig([printfolder 'cortex' sm '_left'], ['-r' num2str(res)], '-a2', '-transparent'); 

figure; showsurface3BS(vc, cortex.Faces_right, surface_pars, data, varargin1{:});
...
% figure; showsurface3BS(vc, sa.cortex75K.tri, surface_pars, data, varargin1{:});
% export_fig([printfolder 'cortex' sm '_top'], ['-r' num2str(res)], '-a2', '-transparent'); 


surface_pars.myviewdir = [0 0 1];

figure; showsurface3BS(vc, cortex.Faces, surface_pars, data, varargin1{:});
